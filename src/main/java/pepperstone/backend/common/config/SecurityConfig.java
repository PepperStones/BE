...
import pepperstone.backend.common.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private final String[] permitPath = {"/", "/auth/**", "/mainpage/**", "/notification/**", "/exp/**", "/challenge/**", "/quest/**", "/board/**", "/mypage/**", "/member/**", "/board/**", "/sync/**"};
...
//        config.setAllowedOriginPatterns(Arrays.asList("https://pipishortstocking.shop"));
